...
class TestGetWeather(object):
    ...
    def test_get_forecast(self, get_weather_from_weather_com):
        ...
        assert forecast['chance_precip'] == expected['day']['chance_precip']
        assert forecast['day_wind_gust'] == expected['day']['wind']['gust']
        ...
        assert forecast['night_wind_gust'] == expected['night']['wind']['gust']
