...
def main():
  ...
  blight(True) #switches on the backlight
  
  sendText(1, "texto ")
  sendText(2, "de prueba",3)
...
def sendText(row, text, justification = 2):
...
# 3: right
  ...
  lcd_byte(rows[row], LCD_CMD)
  lcd_string(text,justification)
